...
router.get("/profile/:userId", verifyToken.authenticateToken, userController.profile);
...
router.put("/updateUser", verifyToken.authenticateToken, userController.updateUser);

router.get('/user-profiles', verifyToken.authenticateToken, userController.getUserProfiles);
router.post("/UserProfile",upload.single('image'),verifyToken.authenticateToken, userController.createUserProfile);
